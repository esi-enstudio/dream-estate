            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('rent.properties') }}" class="btn btn-white btn-lg d-inline-flex align-items-center"><i class="material-icons-outlined me-2">king_bed</i>Rent Property</a>
                    </div>
                </div> <!-- end col -->
            ...
            <div class="row align-items-center gy-4">
                ...
                <div class="col-lg-6">
                    <div class="position-relative" data-aos="fade-up" data-aos-duration="1000">
                        <div><img src="{{ asset('assets/img/section-bg/section-bg-01.png') }}" class="img-fluid" alt=""></div>
                        <div class="position-absolute end-0 top-0">
                            <img src="{{ asset('assets/img/bg/line-01.svg') }}" alt="">
                        </div>
                        <div class="position-absolute start-0 bottom-0">
                            <img src="{{ asset('assets/img/bg/line-02.svg') }}" alt="">
                        </div>
                    </div>
                </div> <!-- end col -->
            ...
            <div class="counter-list">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 d-flex" data-aos="fade-up" data-aos-duration="1000">
                        <div class="counting-item flex-fill">
								<span class="count-icon">
									<img src="{{ asset('assets/img/icons/count-01.svg') }}" alt="">
								</span>
                            <div>
                    ...
                    <div class="col-lg-3 col-sm-6 d-flex" data-aos="fade-up" data-aos-duration="1500">
                        <div class="counting-item flex-fill">
								<span class="count-icon">
									<img src="{{ asset('assets/img/icons/count-02.svg') }}" alt="">
								</span>
                            <div>
                    ...
                    <div class="col-lg-3 col-sm-6 d-flex" data-aos="fade-up" data-aos-duration="2000">
                        <div class="counting-item flex-fill">
								<span class="count-icon">
									<img src="{{ asset('assets/img/icons/count-03.svg') }}" alt="">
								</span>
                            <div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
                    <div class="property-type-item">
                        <div class="property-img">
                            <a href="buy-details.html"><img src="{{ asset('assets/img/property-type/property-type-01.jpg') }}" class="img-fluid" alt=""></a>
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1500">
                    <div class="property-type-item">
                        <div class="property-img">
                            <a href="buy-details.html"><img src="{{ asset('assets/img/property-type/property-type-02.jpg') }}" class="img-fluid" alt=""></a>
                            <a href="buy-details.html" class="overlay-arrow"><i class="material-icons-outlined">north_east</i></a>
                        </div>
                        <div class="text-center">
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="2000">
                    <div class="property-type-item">
                        <div class="property-img">
                            <a href="buy-details.html"><img src="{{ asset('assets/img/property-type/property-type-03.jpg') }}" class="img-fluid" alt=""></a>
                            <a href="buy-details.html" class="overlay-arrow"><i class="material-icons-outlined">north_east</i></a>
                        </div>
                        <div class="text-center">
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="2500">
                    <div class="property-type-item">
                        <div class="property-img">
                            <a href="buy-details.html"><img src="{{ asset('assets/img/property-type/property-type-04.jpg') }}" class="img-fluid" alt=""></a>
                            <a href="buy-details.html" class="overlay-arrow"><i class="material-icons-outlined">north_east</i></a>
                        </div>
                        <div class="text-center">
                    ...
                    <div class="row">
                            ...
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="rent-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/buy/buy-grid-img-01.jpg') }}" alt="">
                                    </a>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3">
                                        ...
                                        <div class="user-avatar avatar avatar-md">
                                            <img src="{{ asset('assets/img/users/user-01.jpg') }}" alt="User" class="rounded-circle">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="rent-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/buy/buy-grid-img-02.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="badge badge-sm bg-danger d-flex align-items-center">
                        ...
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="rent-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/buy/buy-grid-img-03.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="badge badge-sm bg-orange d-flex align-items-center">
                                            <i class="material-icons-outlined">loyalty</i>Featured
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3">
                                        <span class="badge bg-light text-dark">For Rent</span>
                                        <div class="user-avatar avatar avatar-md">
                                            <img src="{{ asset('assets/img/users/user-03.jpg') }}" alt="User" class="rounded-circle">
                                        </div>
                                    </div>
                                </div>
                                <div class="buy-grid-content">
                        ...
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="rent-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/buy/buy-grid-img-04.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="badge badge-sm bg-orange d-flex align-items-center">
                                            <i class="material-icons-outlined">loyalty</i>Featured
                        ...
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="rent-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/buy/buy-grid-img-05.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="badge badge-sm bg-danger d-flex align-items-center">
                                            <i class="material-icons-outlined">offline_bolt</i>Trending
                        ...
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="rent-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/buy/buy-grid-img-06.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="badge badge-sm bg-danger d-flex align-items-center">
                                            <i class="material-icons-outlined">offline_bolt</i>Trending
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3">
                                        <span class="badge bg-light text-dark">For Rent</span>
                                        <div class="user-avatar avatar avatar-md">
                                            <img src="{{ asset('assets/img/users/user-06.jpg') }}" alt="User" class="rounded-circle">
                                        </div>
                                    </div>
                                </div>
                                <div class="buy-grid-content">
                    ...
                    <div class="row">
                            ...
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="buy-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/rent/rent-grid-img-01.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="badge badge-sm bg-danger d-flex align-items-center">
                        ...
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="buy-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/rent/rent-grid-img-02.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="badge badge-sm bg-danger d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3">
                                        <span class="badge bg-light text-dark">For Sale</span>
                                        <div class="user-avatar avatar avatar-md">
                                            <img src="{{ asset('assets/img/users/user-08.jpg') }}" alt="User" class="rounded-circle">
                                        </div>
                                    </div>
                                </div>
                                <div class="buy-grid-content">
                        ...
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="buy-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/rent/rent-grid-img-03.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="badge badge-sm bg-orange d-flex align-items-center">
                                            <i class="material-icons-outlined">loyalty</i>Featured
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3">
                                        <span class="badge bg-light text-dark">For Sale</span>
                                        <div class="user-avatar avatar avatar-md">
                                            <img src="{{ asset('assets/img/users/user-09.jpg') }}" alt="User" class="rounded-circle">
                                        </div>
                                    </div>
                                </div>
                                <div class="buy-grid-content">
                        ...
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="buy-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/rent/rent-grid-img-04.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="badge badge-sm bg-orange d-flex align-items-center">
                                            <i class="material-icons-outlined">loyalty</i>Featured
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3">
                                        <span class="badge bg-light text-dark">For Sale</span>
                                        <div class="user-avatar avatar avatar-md">
                                            <img src="{{ asset('assets/img/users/user-10.jpg') }}" alt="User" class="rounded-circle">
                                        </div>
                                    </div>
                                </div>
                                <div class="buy-grid-content">
                        ...
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="buy-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/rent/rent-grid-img-05.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="badge badge-sm bg-danger d-flex align-items-center">
                                            <i class="material-icons-outlined">offline_bolt</i>Trending
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3">
                                        <span class="badge bg-light text-dark">For Sale</span>
                                        <div class="user-avatar avatar avatar-md">
                                            <img src="{{ asset('assets/img/users/user-11.jpg') }}" alt="User" class="rounded-circle">
                                        </div>
                                    </div>
                                </div>
                                <div class="buy-grid-content">
                        ...
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                            <div class="property-listing-item">
                                <div class="buy-grid-img">
                                    <a href="buy-details.html">
                                        <img class="img-fluid rounded" src="{{ asset('assets/img/rent/rent-grid-img-06.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3">
                                        <div class="badge badge-sm bg-danger d-flex align-items-center">
                                            <i class="material-icons-outlined">offline_bolt</i>Trending
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3">
                                        <span class="badge bg-light text-dark">For Sale</span>
                                        <div class="user-avatar avatar avatar-md">
                                            <img src="{{ asset('assets/img/users/user-12.jpg') }}" alt="User" class="rounded-circle">
                                        </div>
                                    </div>
                                </div>
                                <div class="buy-grid-content">
    ...
    <section class="exclusive-benifit-section">
        <div class="container">
            ...
            <div class="sec-bottom-imgs">
                <div class="bottom-img-1"><img src="{{ asset('assets/img/benifits/benifit-01.jpg') }}" alt=""></div>
                <div class="bottom-img-2"><img src="{{ asset('assets/img/benifits/benifit-02.jpg') }}" alt=""></div>
                <div class="bottom-img-3"><img src="{{ asset('assets/img/benifits/benifit-03.jpg') }}" alt=""></div>
                <div class="bottom-img-4"><img src="{{ asset('assets/img/benifits/benifit-04.jpg') }}" alt=""></div>
                <div class="bottom-img-5"><img src="{{ asset('assets/img/benifits/benifit-05.jpg') }}" alt=""></div>
                <div class="bottom-img-6"><img src="{{ asset('assets/img/benifits/benifit-06.jpg') }}" alt=""></div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
                    <div class="location-item-two">
                        <div class="location-img">
                            <a href="javascript:void(0)"><img src="{{ asset('assets/img/location/location-01.jpg') }}" class="img-fluid" alt=""></a>
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1500">
                    <div class="location-item-two">
                        <div class="location-img">
                            <a href="javascript:void(0)"><img src="{{ asset('assets/img/location/location-02.jpg') }}" class="img-fluid" alt=""></a>
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="2000">
                    <div class="location-item-two">
                        <div class="location-img">
                            <a href="javascript:void(0)"><img src="{{ asset('assets/img/location/location-03.jpg') }}" class="img-fluid" alt=""></a>
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="2500">
                    <div class="location-item-two">
                        <div class="location-img">
                            <a href="javascript:void(0)"><img src="{{ asset('assets/img/location/location-04.jpg') }}" class="img-fluid" alt=""></a>
            ...
            <div class="review-slider swiper" data-aos="fade-up">
                <div class="swiper-wrapper">
                    <div class="review-item-two swiper-slide">
                        <span class="mb-3 d-block"><img src="{{ asset('assets/img/icons/quote-down.svg') }}" class="w-auto m-auto" alt=""></span>
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0)" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2">
                                <img src="{{ asset('assets/img/users/user-02.jpg') }}" alt=""></a>
                            <div>
                    ...
                    <div class="review-item-two swiper-slide">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0)" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('assets/img/users/user-04.jpg') }}" alt=""></a>
                            <div>
                    ...
                    <div class="review-item-two swiper-slide">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0)" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('assets/img/users/user-03.jpg') }}" alt=""></a>
                            <div>
                    ...
                    <div class="review-item-two swiper-slide">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0)" class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img src="{{ asset('assets/img/users/user-06.jpg') }}" alt=""></a>
                            <div>
                    ...
                    <div class="property-sec-img mt-0">
                        <div class="row g-3">
                            <div class="col-md-6 d-flex">
                                <div class="flex-fill">
                                    <div><img src="{{ asset('assets/img/home-3/property/property-01.jpg') }}" class="img-fluid" alt=""></div>
                                </div>
                            </div>
                            <div class="col-md-6 d-flex">
                                <div class="flex-fill">
                                    <div class="mb-3"><img src="{{ asset('assets/img/home-3/property/property-02.jpg') }}" class="img-fluid" alt=""></div>
                                    <div><img src="{{ asset('assets/img/home-3/property/property-03.jpg') }}" alt=""></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
                    <div class="blog-item-two">
                        <div class="blog-content">
                            <div class="blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/img/blogs/blog-img-22.jpg') }}" class="img-fluid" alt=""></a>
                            </div>
                ...
                <div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1500">
                    <div class="blog-item-two">
                        <div class="blog-content">
                            <div class="blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/img/blogs/blog-img-23.jpg') }}" class="img-fluid" alt=""></a>
                            </div>
                            <div class="position-absolute top-0 start-0 p-3 z-1">
                                <div class="blog-date">
                                    <h6 class="mb-0">10</h6>
                ...
                <div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="2000">
                    <div class="blog-item-two">
                        <div class="blog-content">
                            <div class="blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/img/blogs/blog-img-24.jpg') }}" class="img-fluid" alt=""></a>
                            </div>
                            <div class="position-absolute top-0 start-0 p-3 z-1">
                                <div class="blog-date">
                                    <h6 class="mb-0">10</h6>
