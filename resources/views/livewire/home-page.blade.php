                    ...
                    <div class="property-slider">
                        <div class="property-item aos" data-aos="fade-up" data-aos-duration="1000">
                            <div class="property-card-item">
                                <div class="mb-3 text-center">
                                    <img src="{{ asset('assets/img/home/icons/property-icon-1.svg') }}" alt="property-icon-1" class="m-auto">
                                </div>
                        ...
                        <div class="property-item">
                            <div class="property-card-item aos" data-aos="fade-down" data-aos-duration="1000">
                                <div class="mb-3 text-center">
                                    <img src="{{ asset('assets/img/home/icons/property-icon-2.svg') }}" alt="property-icon-1" class="m-auto">
                                </div>
                        ...
                        <div class="property-item aos" data-aos="fade-up" data-aos-duration="1000">
                            <div class="property-card-item">
                                <div class="mb-3 text-center">
                                    <img src="{{ asset('assets/img/home/icons/property-icon-3.svg') }}" alt="property-icon-1" class="m-auto">
                                </div>
                        ...
                        <div class="property-item aos" data-aos="fade-down" data-aos-duration="1000">
                            <div class="property-card-item">
                                <div class="mb-3 text-center">
                                    <img src="{{ asset('assets/img/home/icons/property-icon-4.svg') }}" alt="property-icon-1" class="m-auto">
                                </div>
                            ...
                            <div class="property-listing-item p-0 mb-0 shadow-none">
                                <div class="buy-grid-img mb-0 rounded-0">
                                    <a href="buy-details.html">
                                        <img class="img-fluid" src="{{ asset('assets/img/buy/buy-grid-img-01.jpg') }}" alt="">
                                    </a>
                    ...
                    <div class="d-flex aos" data-aos="fade-down" data-aos-duration="1500">
                        <div class="property-card flex-fill mb-0">
                            <div class="property-listing-item p-0 mb-0 shadow-none">
                                <div class="buy-grid-img mb-0 rounded-0">
                                    <a href="buy-details.html">
                                        <img class="img-fluid" src="{{ asset('assets/img/buy/buy-grid-img-04.jpg') }}" alt="">
                                    </a>
                    ...
                    <div class="d-flex aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="property-card flex-fill">
                            <div class="property-listing-item p-0 mb-0 shadow-none">
                                <div class="buy-grid-img mb-0 rounded-0">
                                    <a href="buy-details.html">
                                        <img class="img-fluid" src="{{ asset('assets/img/buy/buy-grid-img-02.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-end position-absolute top-0 start-0 end-0 p-3 z-1">
                                        <a href="javascript:void(0)" class="favourite">
                                            <i class="material-icons-outlined">favorite_border</i>
                    ...
                    <div class="d-flex aos" data-aos="fade-down" data-aos-duration="1500">
                        <div class="property-card flex-fill mb-0">
                            <div class="property-listing-item p-0 mb-0 shadow-none">
                                <div class="buy-grid-img mb-0 rounded-0">
                                    <a href="buy-details.html">
                                        <img class="img-fluid" src="{{ asset('assets/img/buy/buy-grid-img-05.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-end position-absolute top-0 start-0 end-0 p-3 z-1">
                                        <a href="javascript:void(0)" class="favourite">
                                            <i class="material-icons-outlined">favorite_border</i>
                    ...
                    <div class="d-flex aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="property-card flex-fill">
                            <div class="property-listing-item p-0 mb-0 shadow-none">
                                <div class="buy-grid-img mb-0 rounded-0">
                                    <a href="buy-details.html">
                                        <img class="img-fluid" src="{{ asset('assets/img/buy/buy-grid-img-03.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute top-0 start-0 end-0 p-3 z-1">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="badge badge-sm bg-orange d-flex align-items-center">
                    ...
                    <div class="d-flex aos" data-aos="fade-down" data-aos-duration="1500">
                        <div class="property-card mb-0 flex-fill">
                            <div class="property-listing-item p-0 mb-0 shadow-none">
                                <div class="buy-grid-img mb-0 rounded-0">
                                    <a href="buy-details.html">
                                        <img class="img-fluid" src="{{ asset('assets/img/buy/buy-grid-img-06.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-end position-absolute top-0 start-0 end-0 p-3 z-1">
                                        <a href="javascript:void(0)" class="favourite">
                                            <i class="material-icons-outlined">favorite_border</i>
                    ...
                    <div class="d-flex aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="property-card flex-fill">
                            <div class="property-listing-item p-0 mb-0 shadow-none">
                                <div class="buy-grid-img mb-0 rounded-0">
                                    <a href="buy-details.html">
                                        <img class="img-fluid" src="{{ asset('assets/img/buy/buy-grid-img-07.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-end position-absolute top-0 start-0 end-0 p-3 z-1">
                                        <a href="javascript:void(0)" class="favourite">
                                            <i class="material-icons-outlined">favorite_border</i>
                    ...
                    <div class="d-flex aos" data-aos="fade-down" data-aos-duration="1500">
                        <div class="property-card mb-0 flex-fill">
                            <div class="property-listing-item p-0 mb-0 shadow-none">
                                <div class="buy-grid-img mb-0 rounded-0">
                                    <a href="buy-details.html">
                                        <img class="img-fluid" src="{{ asset('assets/img/buy/buy-grid-img-08.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-end position-absolute top-0 start-0 end-0 p-3 z-1">
                                        <a href="javascript:void(0)" class="favourite">
                                            <i class="material-icons-outlined">favorite_border</i>
        ...
        <div class="container">
            ...
            <div class="cities-slider">
                ...
                <div class="city-items-slide" >
                    ...
                    <div class="city-item position-relative mb-4 aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="city-img position-relative">
                            <img src="{{ asset('assets/img/home/city/city-img-1.jpg') }}" alt="City" class="img-fluid">
                        </div>
                        <div class="city-name">
                    ...
                    <div class="city-item position-relative aos" data-aos="fade-down" data-aos-duration="1500">
                        <div class="city-img position-relative">
                            <img src="{{ asset('assets/img/home/city/city-img-4.jpg') }}" alt="City" class="img-fluid">
                        </div>
                        <div class="city-name">
                ...
                <div class="city-items-slide">
                    ...
                    <div class="city-item position-relative mb-4 aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="city-img position-relative">
                            <img src="{{ asset('assets/img/home/city/city-img-2.jpg') }}" alt="City" class="img-fluid">
                        </div>
                        <div class="city-name">
                    ...
                    <div class="city-item position-relative aos" data-aos="fade-down" data-aos-duration="1500">
                        <div class="city-img position-relative">
                            <img src="{{ asset('assets/img/home/city/city-img-5.jpg') }}" alt="City" class="img-fluid">
                        </div>
                        <div class="city-name">
                ...
                <div class="city-items-slide" >
                    ...
                    <div class="city-item position-relative mb-4 aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="city-img position-relative">
                            <img src="{{ asset('assets/img/home/city/city-img-3.jpg') }}" alt="City" class="img-fluid">
                        </div>
                        <div class="city-name">
                            <h5 class="mb-1">New York</h5>
                            <p class="mb-0">300 Properties</p>
                    ...
                    <div class="city-item position-relative aos" data-aos="fade-down" data-aos-duration="1500">
                        <div class="city-img position-relative">
                            <img src="{{ asset('assets/img/home/city/city-img-6.jpg') }}" alt="City" class="img-fluid">
                        </div>
                        <div class="city-name">
                            <h5>Singapore</h5>
                            <p>400 Properties</p>
                    ...
                    <div class="d-flex aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="property-card flex-fill">
                            <div class="property-listing-item p-0 mb-0 shadow-none">
                                <div class="buy-grid-img mb-0 rounded-0">
                                    <a href="rent-details.html">
                                        <img class="img-fluid" src="{{ asset('assets/img/rent/rent-grid-img-07.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3 z-1">
                                ...
                                <div class="buy-grid-content">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap border-top border-light-100 pt-3 gap-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-lg user-avatar">
                                                <img src="{{ asset('assets/img/users/user-16.jpg') }}" alt="" class="rounded-circle">
                                            </div>
                    ...
                    <div class="d-flex aos" data-aos="fade-down" data-aos-duration="1500">
                        <div class="property-card mb-0 flex-fill">
                            <div class="property-listing-item p-0 mb-0 shadow-none">
                                <div class="buy-grid-img mb-0 rounded-0">
                                    <a href="rent-details.html">
                                        <img class="img-fluid" src="{{ asset('assets/img/rent/rent-grid-img-08.jpg') }}" alt="">
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3 z-1">
                                ...
                                <div class="buy-grid-content">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap border-top border-light-100 pt-3 gap-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-lg user-avatar">
                                                <img src="{{ asset('assets/img/users/user-17.jpg') }}" alt="" class="rounded-circle">
                                            </div>
        ...
        <div class="container">
            ...
            <div class="d-flex align-items-center justify-content-lg-between justify-content-md-between justify-content-center flex-wrap gap-2">
                <div class="statistics-item d-flex align-items-center gap-2 flex-wrap aos" data-aos="fade-down" data-aos-duration="1000">
                    <div>
                        <img src="{{ asset('assets/img/home/icons/stat-icon-1.svg') }}" alt="stat-icon-1" class="img-fluid stat-img">
                    </div>
                    <div>
                ...
                <div class="statistics-item d-flex align-items-center gap-2 flex-wrap aos" data-aos="fade-up" data-aos-duration="1000">
                    <div>
                        <img src="{{ asset('assets/img/home/icons/stat-icon-2.svg') }}" alt="stat-icon-1" class="img-fluid stat-img">
                    </div>
                    <div>
                ...
                <div class="statistics-item d-flex align-items-center gap-2 flex-wrap aos" data-aos="fade-down" data-aos-duration="1000">
                    <div>
                        <img src="{{ asset('assets/img/home/icons/stat-icon-3.svg') }}" alt="stat-icon-1" class="img-fluid stat-img">
                    </div>
                    <div>
                ...
                <div class="statistics-item d-flex align-items-center gap-2 flex-wrap aos" data-aos="fade-up" data-aos-duration="1000">
                    <div>
                        <img src="{{ asset('assets/img/home/icons/stat-icon-4.svg') }}" alt="stat-icon-1" class="img-fluid stat-img">
                    </div>
                    <div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="buy-property-item text-center mb-lg-0 mb-md-0  mb-4 aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="img-card overflow-hidden text-center">
                            <a href="buy-property-grid.html"><img src="{{ asset('assets/img/home/city/property-img-1.jpg') }}" alt="Property Image"></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6" >
                    <div class="buy-property-item mb-lg-0 mb-4 text-center aos" data-aos="fade-up" data-aos-duration="1000">
                        <div class="img-card overflow-hidden text-center">
                            <a href="rent-property-grid.html"><img src="{{ asset('assets/img/home/city/property-img-2.jpg') }}" alt="Property Image"></a>
                        </div>
                        <div class="buy-property bg-white d-flex align-items-center justify-content-between">
                ...
                <div class="col-lg-4 col-md-6" >
                    <div class="buy-property-item mb-0 text-center aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="img-card overflow-hidden text-center">
                            <a href="rent-property-grid.html"><img src="{{ asset('assets/img/home/city/property-img-3.jpg') }}" alt="Property Image"></a>
                        </div>
                        <div class="buy-property bg-white d-flex align-items-center justify-content-between">
            ...
            <div class="partners-slide-item partners-slider">
                <div class="partners-slide aos" data-aos="fade-right" data-aos-duration="1000">
                    <div class="partners-items">
                        <img src="{{ asset('assets/img/home/icons/partners-img-1.svg') }}" alt="partners-icon-1.svg') }}" class="img-fluid partners-icon">
                    </div>
                </div>

                <div class="partners-slide">
                    <div class="partners-items aos" data-aos="fade-right" data-aos-duration="1500">
                        <img src="{{ asset('assets/img/home/icons/partners-img-2.svg') }}" alt="partners-icon-1.svg') }}" class="img-fluid partners-icon">
                    </div>
                </div>

                <div class="partners-slide">
                    <div class="partners-items aos" data-aos="fade-right" data-aos-duration="1000">
                        <img src="{{ asset('assets/img/home/icons/partners-img-3.svg') }}" alt="partners-icon-1.svg') }}" class="img-fluid partners-icon">
                    </div>
                </div>

                <div class="partners-slide">
                    <div class="partners-items aos" data-aos="fade-right" data-aos-duration="1500">
                        <img src="{{ asset('assets/img/home/icons/partners-img-4.svg') }}" alt="partners-icon-1.svg') }}" class="img-fluid partners-icon">
                    </div>
                </div>

                <div class="partners-slide">
                    <div class="partners-items aos" data-aos="fade-right" data-aos-duration="1000">
                        <img src="{{ asset('assets/img/home/icons/partners-img-5.svg') }}" alt="partners-icon-1.svg') }}" class="img-fluid partners-icon">
                    </div>
                </div>
            ...
            <div class="testimonials-slider-item testimonials-slider">
                ...
                <div class="testimonials-slide">
                    ...
                    <div class="testimonials-item aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="avatar avatar-lg mb-4">
                            <img src="{{ asset('assets/img/users/user-02.jpg') }}" alt="user-01" class="img-fluid rounded-circle">
                        </div>
                ...
                <div class="testimonials-slide">
                    ...
                    <div class="testimonials-item aos" data-aos="fade-up" data-aos-duration="1000">
                        <div class="avatar avatar-lg mb-4">
                            <img src="{{ asset('assets/img/users/user-01.jpg') }}" alt="user-01" class="img-fluid rounded-circle">
                        </div>
                ...
                <div class="testimonials-slide">
                    ...
                    <div class="testimonials-item aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="avatar avatar-lg mb-4">
                            <img src="{{ asset('assets/img/users/user-03.jpg') }}" alt="user-01" class="img-fluid rounded-circle">
                        </div>
                ...
                <div class="testimonials-slide">
                    ...
                    <div class="testimonials-item aos" data-aos="fade-up" data-aos-duration="1000">
                        <div class="avatar avatar-lg mb-4">
                            <img src="{{ asset('assets/img/users/user-04.jpg') }}" alt="user-01" class="img-fluid rounded-circle">
                        </div>
                ...
                <div class="testimonials-slide">
                    ...
                    <div class="testimonials-item aos" data-aos="fade-down" data-aos-duration="1000">
                        <div class="avatar avatar-lg mb-4">
                            <img src="{{ asset('assets/img/users/user-06.jpg') }}" alt="user-01" class="img-fluid rounded-circle">
                        </div>
                        <p class="mb-2"> Dreams Estate made home booking a breeze. Super easy and stress-free! listing Portal of all time </p>
                        <h6 class="mb-2"> Daniel Cooper </h6>
                        <div class="d-flex align-items-center justify-content-center">
