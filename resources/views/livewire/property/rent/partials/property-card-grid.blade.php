<div class="property-card flex-fill {{ !$loop->last ? 'mb-4' : 'mb-0' }}">
    <div class="property-listing-item p-0 mb-0 shadow-none">
        ...
        <div class="buy-grid-content">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div>
                    <h6 class="title mb-1"><a href="{{ route('listing.details', $property->slug) }}">{{ $property->title }}</a></h6>
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-1">
                <p class="fs-14 fw-medium text-dark mb-0">Listed: <span class="fw-medium text-body">{{ $property->created_at->format('d M Y') }}</span></p>
                <p class="fs-14 fw-medium text-dark mb-0">Type: <span class="fw-medium text-body">{{ $property->propertyType->name_bn }}</span></p>
            </div>
        </div>
    </div>
</div>
