        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
            ...
            <div class="d-flex align-items-center flex-wrap gap-3 author-details">
                <div class="d-flex align-items-center me-3">
                    <a href="#">
                        <img src="{{ \Illuminate\Support\Facades\Storage::url($post->user->avatar_url) ?? asset('assets/img/users/default-avatar.png') }}" alt="{{ $post->user->name }}" class="avatar avatar-sm rounded-circle me-2">
                    </a>
